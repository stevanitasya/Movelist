...
<div class="container">
    ...
    <form enctype="multipart/form-data" action={{url('edit-movie/'.$movies->id)}} method="POST">
        {{csrf_field()}}
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="movie_desc" name="description" width="50px" value="{{$movies->description}}">
            @error('description')
                {{$message}}
            @enderror
        </div>
        <div class="mb-3">
            ...
            <select class="form-select" aria-label="Default select example">
                ...
                @foreach ($genres as $g)
                    <option id="multiselect" value="{{$g->name}}">{{$g->name}}</option>
                @endforeach
            </select>
        </div>    
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="movie_director" name="director" value="{{$movies->director}}">
            @error('director')
                {{$message}}
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="movie_date" name="release_date" value="{{$movies->release_date}}">
            @error('release_date')
                {{$message}}
            @enderror
        </div>
